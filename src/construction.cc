...
void MyDetectorConstruction::ConstructHPGeSetup()
{
  ...
  physNaI.push_back(
      new G4PVPlacement(0, G4ThreeVector(-11.6 * cm, 0. * cm, -11.0 * cm), logicNaI,
                        "physNaI_12", logicWorld, true, 133, true));
  physNaI.push_back(
      new G4PVPlacement(0, G4ThreeVector(11.6 * cm, 0. * cm, -11.0 * cm), logicNaI,
                        "physNaI_12", logicWorld, true, 134, true));
  physNaI.push_back(
      new G4PVPlacement(0, G4ThreeVector(0. * cm, -11.6 * cm, -11.0 * cm), logicNaI,
                        "physNaI_12", logicWorld, true, 135, true));
  physNaI.push_back(
      new G4PVPlacement(0, G4ThreeVector(0. * cm, 11.6 * cm, -11.0 * cm), logicNaI,
                        "physNaI_12", logicWorld, true, 136, true));
