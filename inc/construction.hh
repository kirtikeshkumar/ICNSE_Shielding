...
private:
  ...
  G4VPhysicalVolume *physshellMuVetoOut, *physshellHDPEOuter, *physshellBP,
      *physshellLead, *physshellHDPEInner, *physshellMuVetoIn,
      *physshellCuColdBox;
  G4LogicalVolume *logicshellMuVetoOut, *logicshellHDPEOuter, *logicshellBP,
      *logicshellLead, *logicshellHDPEInner, *logicshellMuVetoIn,
      *logicshellCuColdBox;
  G4VPhysicalVolume *physshell0, *physshell1, *physshell2, *physshell3,
      *physshell4, *physshell5, *physshell6, *physshell7;
  G4LogicalVolume *logicshell0, *logicshell1, *logicshell2, *logicshell3,
      *logicshell4, *logicshell5, *logicshell6, *logicshell7;
  ...
  std::vector<G4VSolid *> solidVols;
  std::vector<G4LogicalVolume *> logicVols;
  std::vector<G4VPhysicalVolume *> physVols;
  G4VSolid *solid;
  G4LogicalVolume *logic;
  G4VPhysicalVolume *phys;
  std::vector<G4double> width;
  ...
  G4VSolid *SubtractBoxfrmShell(G4ThreeVector shellsz, double thickness,
                                double offset, G4ThreeVector Boxsz,
                                G4ThreeVector relPosSubVol);
  G4VSolid *SubtractBoxfrmShell(G4ThreeVector shellsz, double thickness,
                                double offset, G4ThreeVector Boxsz);
